...
extension Font {
    ...
    // Regular
    static var PretendardRegualr20: Font {
        return .pretend(type: .regular, size: 20)
    }
    static var PretendardRegualr18: Font {
        return .pretend(type: .regular, size: 18)
    }
    static var PretendardRegualr13: Font {
        return .pretend(type: .regular, size: 13)
    }
    static var PretendardRegualr12: Font {
        return .pretend(type: .regular, size: 12)
    }
    static var PretendardRegualr09: Font {
